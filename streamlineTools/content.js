...
class ExtractPageVariable {
    ...
    _inject() {
        function propagateVariable(handShake, variableName) {
            ...
            // let message1 = JSON.parse(JSON.stringify(message, variableName));
            console.log("message[variableName]");
            console.log(message[variableName]);
            let postMessage = jsonPath(message[variableName], "$.widget.items[1].component.widget.items[1].component.widget.items[0].component.data");
