...
document.addEventListener('click', function (evnt) {
  ...
  //     document.getElementsByTagName('iframe').focus()
  ...
  function (evt) {
    ...
    if (bodyModalHook[0]) {
      if (bodyModalHook[0].innerHTML.includes('<div class="ext-el-mask" style="display: block;"><div class="ext-el-mask-msg" style="display: block; left: 655px; top: 626px;"><div>Loading...</div></div></div>')) {
        console.log(bodyModalHook[0].innerHTML.includes('<div class="ext-el-mask" style="display: block;"><div class="ext-el-mask-msg" style="display: block; left: 655px; top: 626px;"><div>Loading...</div></div></div>'))
      } else {
